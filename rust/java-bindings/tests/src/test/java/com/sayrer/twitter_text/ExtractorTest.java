...
public class ExtractorTest extends TestCase {
  ...
  public static Test suite() {
    final Class<?>[] testClasses = {OffsetConversionTest.class, ReplyTest.class,
  ...
  public static class ReplyTest extends ExtractorTest {
    public void testReplyAtTheStart() {
      final String extracted = extractor.extractReplyScreenname("@user reply");
  ...
  public static class URLTest extends ExtractorTest {
    ...
    public void testUrlWithoutProtocol() {
      final String text = "www.twitter.com, www.yahoo.co.jp, t.co/blahblah, www.poloshirts.uk.com";
      assertList("Failed to extract URLs without protocol",
          new String[]{"www.twitter.com", "www.yahoo.co.jp", "t.co/blahblah",
    ...
    public void testURLFollowedByPunctuations() {
      final String text = "http://games.aarp.org/games/mahjongg-dimensions.aspx!!!!!!";
    ...
    public void testUrlnWithSupplementaryCharacters() {
      ...
      final String text = String.format("%c http://twitter.com %c http://twitter.com", 0x00010400,
          0x00010400);
