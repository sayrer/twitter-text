...
#define SWIGV8_INIT twittertext_initialize




#if (V8_MAJOR_VERSION-0) < 5
static void _wrap_twittertext_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#else
  static void _wrap_twittertext_set(v8::Local<v8::Name> property, v8::Local<v8::Value> value, const SwigV8PropertyCallbackInfoVoid &info) {
#endif
    SWIGV8_HANDLESCOPE();
    ...
    {
      res1 = SWIG_ConvertPtr(value, &argp1, SWIGTYPE_p_namespace,  0 );
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "twittertext_set" "', argument " "1"" of type '" "namespace""'"); 
      }  
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "twittertext_set" "', argument " "1"" of type '" "namespace""'");
      } else {
...
#if (V8_MAJOR_VERSION-0) < 5
static SwigV8ReturnValue _wrap_twittertext_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
#else
  static SwigV8ReturnValue _wrap_twittertext_get(v8::Local<v8::Name> property, const SwigV8PropertyCallbackInfo &info) {
#endif
    SWIGV8_HANDLESCOPE();
    ...
    result = twittertext;
    jsresult = SWIG_NewPointerObj((namespace *)memcpy((namespace *)calloc(1,sizeof(namespace)),&result,sizeof(namespace)), SWIGTYPE_p_namespace, SWIG_POINTER_OWN |  0 );
...
#endif
{
  ...
  SWIGV8_AddStaticVariable(exports_obj, "twittertext", _wrap_twittertext_get, _wrap_twittertext_set);
...
NODE_MODULE(twittertext, twittertext_initialize)
#endif
